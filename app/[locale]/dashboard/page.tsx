            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground mb-1">Pro</div>
                ...
                <div className="flex items-center justify-between p-6 bg-gradient-to-r from-hot-pink/10 to-bright-yellow/10 rounded-xl border border-hot-pink/20">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {t('subscription.renewsOn')} {new Date(subscriptionData.nextBilling).toLocaleDateString(locale)}
                    </p>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full justify-start hover:bg-red-50 hover:border-red-200 hover:text-red-600 dark:hover:bg-red-950 dark:hover:border-red-800 dark:hover:text-red-400"
                  >
