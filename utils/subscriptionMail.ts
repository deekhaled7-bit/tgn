													...
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center">
																	<div class="fullWidth" style="max-width: 680px;"><img src="https://259071beb2.imgdist.com/pub/bfra/ai5ijq1c/4iw/yom/0k5/Post%208.png" style="display: block; height: auto; border: 0; width: 100%;" width="680" alt="An open email illustration" title="An open email illustration" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
