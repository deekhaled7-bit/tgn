...
export function Navigation({ isLoggedIn = false, userRole = 'user' }: NavigationProps) {
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          >
            <div className="h-8 w-8 rounded-full bg-gradient-to-br from-hot-pink to-bright-yellow" />
            ...
            {isLoggedIn ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align={isRTL ? 'start' : 'end'}>
                  ...
                  {userRole === 'user' && (
                    <DropdownMenuItem asChild>
                      <Link href={`/${locale}/subscribe`} className="flex items-center">
              ...
              <div className="hidden sm:flex items-center space-x-2 rtl:space-x-reverse">
                ...
                <Button asChild className="button-glow bg-gradient-to-r from-hot-pink to-bright-yellow hover:shadow-lg">
            ...
            <div className="flex flex-col space-y-4">
              ...
              {!isLoggedIn && (
                <div className="flex flex-col space-y-2 pt-4 border-t">
                  ...
                  <Button asChild className="button-glow bg-gradient-to-r from-hot-pink to-bright-yellow">
                    <Link href={`/${locale}/signup`}>{t('signup')}</Link>
                  </Button>
                </div>
              )}
